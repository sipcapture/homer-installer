...
--deb-no-default-config-files --description "Homer 5 Installer" --before-install ./data/usr/src/homer-installer/prep.sh --after-install ./data/usr/src/homer-installer/install.sh \
